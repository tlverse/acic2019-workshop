...
1. Understand and describe the essential properties of dynamic and optimal individualized treatment regimes. 
How may this formalism be used to define causal effects? How do dynamic treatment regimes differ from static and stochastic regimes?
2. Understand and describe the benefits and challenges associated with using 
optimal individualized treatment regimes in practice.
3. Use the `tmle3mopttx` R package to successfully estimate the causal effects
of an optimal individualized treatment on simulated data.
4. Understand and describe how variable importance measures may be defined in
