...
binary treatment, a key quantity for optimal ITR is the _blip_ function.
...
* \textbf{QUESTION:} What if the treatment is categorical? Can we still use the blip function?
...
* \textbf{QUESTION:} Why do you think the estimate 
