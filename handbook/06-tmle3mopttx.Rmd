...
* \bf{QUESTION:} What if the treatment is categorical? Can we still use the blip function?
...
* \bf{QUESTION:} With categorical treatment, what is the dimension of the blip now? 
...
* \bf{QUESTION:} Why do you think the estimate 
...
* \bf{QUESTION:} Referring back to the data-generating distribution, why do you 
...
* Look at the estimate, and the distribution of treatments assigned:
