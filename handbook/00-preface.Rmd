## Preface / Motivation for Handbook ? {-}
...
reproduced and that report false discoveries.
...
> "The key for effective classical inference is to have well-defined questions and
an analysis plan that tests those questions."
>
...
other restrictive) statistical model @van2014entering.
...
sound methodology of Targeted Learning --- a technique that provides tailored a
priori specified machines for answering queries, so that each data analysis is
...
implementing a specific estimator or a small set of related estimators. Instead,
the focus is on exposing the statistical framework of Targeted Learning
