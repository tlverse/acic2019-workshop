## Preface / Foreward / Motivation /Background (idk)

**Maybe this info is not necessary**
...
crucial that it is accompanied by robust software. The \texttt{tlverse}
...
the methodology. In particular, the \texttt{tlverse} paradigm does not focus on
...
itself! All \texttt{R} packages in the \texttt{tlverse} ecosystem directly model
...
\texttt{tlverse}. Guided by \texttt{R} programming exercises, case studies, and
