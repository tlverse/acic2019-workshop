...
the causal quantity of interest $\E_0 \{Y_{d(A, W)}\}$ is identified by a
...
```{r shift_demo, fig.cap="Animation of how a counterfactual outcome changes as the natural treatment distribution is subjected to a simple stochastic intervention", echo=FALSE, eval=TRUE, out.width='60%'}
