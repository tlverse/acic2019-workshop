...
head(washb_data, 3) %>% kable(format = 'html', digits = 3)
```
...
head(sl_preds)
sl_fit$print() %>% kable(format = 'html', digits = 3)
```
## Extensions
...
sl_fancy_fit$print() %>% kable(format = 'html', digits = 3)
```
...
CVsl_fancy %>% kable(format = 'html', digits = 3)
```
