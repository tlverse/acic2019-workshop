...
<img style="float: center; margin-right: 1%; margin-bottom: 0.05em"
     src="img/misc/ad_workshop.png" width="50%" height="50%">
<br>
...
instructions](https://github.com/tlverse/acic2019-workshop/blob/master/install.R).
...
**Piazza**
We will use Piazza for discussion, Q&A, and sharing URLs and bits
of code.
