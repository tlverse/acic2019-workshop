...
Please install the relevant software before the workshop. For those who run into
installation/software issues, we would like to address this before the workshop
begins at 9am. Please arrive at 8:30am next Wednesday if you have software
installation issues.

* [installation script](https://github.com/tlverse/acic2019-workshop/blob/master/install.R).
...
* 09:00AM--09:15AM: Introduction to the [`tlverse` software
    ecosystem](https://tlverse.org)
* 09:15AM--09:45AM: The Roadmap of Targeted Learning, and the [WASH
    Benefits](http://www.washbenefits.net/) data
* 09:45AM--10:00AM: [Why we need a statistical
...
* 10:30AM--11:15AM: Ensemble machine learning with the
